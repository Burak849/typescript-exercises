...
const add = (a, b = 1) => a + b; // you dont need return if you have single row for arrow function, It has default arg
console.log(add(2, 5));
...
const copiedPerson = Object.assign({}, person); // it takes all key values
...
export {};
//# sourceMappingURL=modulelect.js.map