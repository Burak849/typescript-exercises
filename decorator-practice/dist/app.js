...
// }  WE ADDED THEM TO drag-drop-interfaces.ts FILE
//! 3 slashes is speacial thing in typescript it means referancing to a file
// /// <reference path="models/drag-drop-interfaces.ts" />
// /// <reference path="models/project-model.ts" />
// /// <reference path="states/project-state.ts" />
// /// <reference path="utilities/validation.ts" />
// /// <reference path="decorators/autobind.ts" />  we added to files
// /// <reference path="components/project-input.ts" />
// /// <reference path="components/project-list.ts" />  we are going to make importing
// namespace App{ // we must put everyting that we coded inside of this
// no need anymore we will import
// we are getting all the codes to bundle.js by using tsconfig.json outfile and amd module
new project_input_1.Input();
